...
// Events will be loaded from backend `/api/events`.
...
export default function DashboardAdminAcara() {
    ...
    const fetchEvents = async () => {
        ...
        try {
            ...
            setEvents(list);
            if (list.length > 0) setFeaturedEvent(list[0]);
        } catch {
            setEvents([]);
        } finally {
...
return (
        <div className="min-h-screen overflow-x-hidden bg-[#e7f5e5] font-sans text-gray-900">
            <div className="min-h-screen flex">
                ...
                {/* SIDEBAR — konsisten sama DashboardAdminAnggota */}
